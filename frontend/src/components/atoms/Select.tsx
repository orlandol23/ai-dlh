...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex h-11 w-full items-center justify-between rounded-sm border border-input bg-card px-3 py-2 text-sm ring-offset-background',
      'placeholder:text-muted-foreground focus-ring-v2',
